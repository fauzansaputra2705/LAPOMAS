        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            <h2 class="number">{{ $totalpetugas }}</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            ...
                            <span class="desc">Sudah Ditanggapi</span>
                            <div class="icon">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            ...
                            <span class="desc">Sedang Diproses</span>
                            <div class="icon">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            ...
                            <span class="desc">Belum Ditanggapi</span>
                            <div class="icon">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            ...
                            <span class="desc">Total Pengaduan</span>
                            <div class="icon">
                               <i class="zmdi zmdi-apps"></i>
                            </div>
                        </div>
