...
<head>
  ...
  <title>Login Aplikasi LAPOMAS</title>
  <!-- Font Awesome -->
...
<body>
  ...
  <header>
    ...
    <!-- Full Page Intro -->
    <div class="view"
      style="background-image: url('img/1234.JPG'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
